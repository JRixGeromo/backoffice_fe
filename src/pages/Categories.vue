  ...
  <div class="dash-content-area-inner">
	...
	<div class="dash-title-area-inner">
		...
		<a href="javascript:void(0)">
			...
			<path d="M21.3333 16H16C16 17.0609 15.5786 18.0783 14.8284 18.8284C14.0783 19.5786 13.0609 20 12 20C10.9391 20 9.92172 19.5786 9.17157 18.8284C8.42143 18.0783 8 17.0609 8 16H2.66667V2.66667H21.3333V16ZM21.3333 0H2.66667C1.18667 0 0 1.2 0 2.66667V21.3333C0 22.0406 0.280951 22.7189 0.781048 23.219C1.28115 23.719 1.95942 24 2.66667 24H21.3333C22.0406 24 22.7189 23.719 23.219 23.219C23.719 22.7189 24 22.0406 24 21.3333V2.66667C24 1.95942 23.719 1.28115 23.219 0.781048C22.7189 0.280951 22.0406 0 21.3333 0Z" fill="#367BF5"/>
			</svg>
		</a>
		</div>
	</div>
			...
			<div class="per-bottom-con-area">
				...
				<ul>
					...
					<a href="javascript:void(0)">
						...
						<path d="M2.115 -0.000122183L9 6.80446L15.885 -0.000122183L18 2.105L9 10.9999L0 2.105L2.115 -0.000122183Z" fill="#EA3D2F"/>
						</svg>
						</div>
						<h6>Move Down</h6>
					</a>
					...
					<a href="javascript:void(0)">
						...
						<path d="M16 1.11099H12L10.8571 -0.00012207H5.14286L4 1.11099H0V3.33321H16V1.11099ZM1.14286 17.7777C1.14286 18.367 1.38367 18.9323 1.81233 19.349C2.24098 19.7658 2.82236 19.9999 3.42857 19.9999H12.5714C13.1776 19.9999 13.759 19.7658 14.1877 19.349C14.6163 18.9323 14.8571 18.367 14.8571 17.7777V4.44432H1.14286V17.7777Z" fill="#EA3D2F"/>
						</svg>
						</div>
						<h6>Remove section</h6>
					</a>
					</li>
				</ul>
				</div>
		...
		<div class="dash-chart-title-inner">
			...
			<ul>
				...
				<a href="javascript:void(0)">
					...
					<path d="M8.825 8.50953e-07L5 3.7085L1.175 1.82168e-07L-5.28948e-07 1.1417L5 6L10 1.1417L8.825 8.50953e-07Z" fill="white"/>
					</svg>
				</a>
				</li>
				...
				<a href="javascript:void(0)">
					...
					<path d="M0 10H1.66667V8.33333H0V10ZM2.77778 10H4.44444V6.11111H2.77778V10ZM5.55556 10H7.22222V3.33333H5.55556V10ZM8.33333 10H10V0H8.33333V10Z" fill="#868686"/>
					</svg>
				</a>
				</li>
				<li class="second-icon-list">
				<a href="javascript:void(0)">
					...
					<path d="M12 10H0V3.15789L4.3 5.78947L6.81333 4.24561L12 7.39649V10ZM0 1.53684V0L4.3 2.63158L6.81333 1.08772L12 4.2386V5.78947L6.81333 2.63158L4.3 4.15439L0 1.53684Z" fill="#868686"/>
					</svg>
				</a>
				</li>
				<li>
				<a href="javascript:void(0)" class="chart-popup-btn">
					<svg width="28" height="6" viewBox="0 0 28 6" fill="none" xmlns="http://www.w3.org/2000/svg">
					<g opacity="0.5">
					<circle cx="25" cy="3" r="3" fill="#868686"/>
					<circle cx="14" cy="3" r="3" fill="#868686"/>
				...
				<div class="dash-chart-item-inner">
					...
					<div class="chart-bottom-area-inner">
						...
						<div class="chart-bottom-left">
							...
							<path fill-rule="evenodd" clip-rule="evenodd" d="M12.8 0H1.6C0.72 0 0 0.72 0 1.6V12.8C0 13.68 0.72 14.4 1.6 14.4H12.8C13.68 14.4 14.4 13.68 14.4 12.8V1.6C14.4 0.72 13.68 0 12.8 0ZM5.6 11.2L1.6 7.2L2.72 6.08L5.6 8.96L11.68 2.88L12.8 4L5.6 11.2Z" fill="#F3AA18"/>
							</svg>
						...
						<div class="chart-bottom-left">
							<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M12.8 0H1.6C0.72 0 0 0.72 0 1.6V12.8C0 13.68 0.72 14.4 1.6 14.4H12.8C13.68 14.4 14.4 13.68 14.4 12.8V1.6C14.4 0.72 13.68 0 12.8 0ZM5.6 11.2L1.6 7.2L2.72 6.08L5.6 8.96L11.68 2.88L12.8 4L5.6 11.2Z" fill="#367BF5"/>
							</svg>
			...
			<div class="col-lg-6">
				...
				<div class="dash-chart-item-inner">
					...
					<div class="chart-bottom-area-inner">
						...
						<div class="chart-bottom-left">
							<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M12.8 0H1.6C0.72 0 0 0.72 0 1.6V12.8C0 13.68 0.72 14.4 1.6 14.4H12.8C13.68 14.4 14.4 13.68 14.4 12.8V1.6C14.4 0.72 13.68 0 12.8 0ZM5.6 11.2L1.6 7.2L2.72 6.08L5.6 8.96L11.68 2.88L12.8 4L5.6 11.2Z" fill="#2FA84F"/>
							</svg>
							<p>Month to Date (Jun 1 - 19,2021)</p>
						</div>
						<div class="chart-bottom-right">
						...
						<div class="chart-bottom-left">
							<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M12.8 0H1.6C0.72 0 0 0.72 0 1.6V12.8C0 13.68 0.72 14.4 1.6 14.4H12.8C13.68 14.4 14.4 13.68 14.4 12.8V1.6C14.4 0.72 13.68 0 12.8 0ZM5.6 11.2L1.6 7.2L2.72 6.08L5.6 8.96L11.68 2.88L12.8 4L5.6 11.2Z" fill="#EA3D2F"/>
							</svg>
							<p>Previous Year (Jun 1 - 29,2020)</p>
						</div>
						<div class="chart-bottom-right">
			...
			<div class="per-poup-con-inner">
				...
				<div class="per-bottom-con-area-inner">
					...
					<li>
						...
						<div class="icon-area">
							<svg width="18" height="11" viewBox="0 0 18 11" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M2.115 11L9 4.19542L15.885 11L18 8.89488L9 0L0 8.89488L2.115 11Z" fill="#EA3D2F"/>
							</svg>
						</div>
						<h6>Move Up</h6>
						</a>
	...
	<div class="leaderboard-popup-main">
		<div class="per-pop-menu-main">
		<div class="per-pop-menu-inner-area">
			<div class="per-pop-menu-heading-area">
			<h2>Leaderboard</h2>
...
export default defineComponent({
  ...
  mounted() {
    this.sales.isLoaded = false
    this.orders.isLoaded = false
    axios.get('analytics/overview').then((response) => {
      const salesResult = response.data.sales

      this.sales.chartData = {
        labels: salesResult.filter(s => s.date.includes('2020')).map(function(data) {
          return data.date
        }),
        datasets: [
          {
            label: 'Net Sales 2021',
            //fill: false,
            borderColor: '#fd7e14',
            backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
            ...
            borderWidth: 1,
            data: salesResult.filter(s => s.date.includes('2021')).map(function(data) {
              return data.net_sales
            }),
          },          
          {
            label: 'Net Sales 2020',
            //fill: false,
            borderColor: '#0d6efd',
            backgroundColor: ['rgb(133 204 255 / 20%)'],
            borderWidth: 1,
            data: salesResult.filter(s => s.date.includes('2020')).map(function(data) {
              return data.net_sales
            }),
          }
        ],
      ...
      this.sales.isLoaded = true

      this.orders.chartData = {
        labels: salesResult.filter(s => s.date.includes('2020')).map(function(data) {
          return data.date
        }),
        datasets: [
      ...
      this.orders.isLoaded = true
    })

    // axios.get('analytics/customers').then((response) => {
    //   const customersResult = response.data.customers
    // }),

    // axios.get('analytics/countries').then((response) => {
    //   const countriesResult = response.data.countries
    // }),
